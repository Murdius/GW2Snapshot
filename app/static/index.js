...
var Form = React.createClass({
  handleKeySubmit1 : function(key) {
    $.ajax({
      ...
      success: function(data) {
        this.setState({data: "First snapshot taken"});
      }.bind(this),
  ...
  handleKeySubmit2 : function(key) {
    $.ajax({
      ...
      success: function(data) {
        ...
        this.setState({wallet_data: parsed.list});
      }.bind(this),
      error: function(xhr, status, err) {
        console.error(this.props.url, status, err.toString());
      }.bind(this)
    ...
    $.ajax({
      ...
      success: function(data) {
        var parsed = JSON.parse(data);
        this.setState({item_data: parsed.data.condensed_list2, zero_data: parsed.data.zero_value_items, total_value: parsed.data.total_value, data: "Second snapshot taken"});
      }.bind(this),
      error: function(xhr, status, err) {
        console.error(this.props.url, status, err.toString());
      }.bind(this)
  ...
  getInitialState : function() {
    return {data: [], wallet_data: [], item_data: [], zero_data: [], total_value: 0};
  },
  render : function() {
    return (
